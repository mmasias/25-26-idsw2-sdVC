...
Documentar el diseno conceptual de asignarTareaAUsuario() manteniendo trazabilidad directa con los diagramas de analisis. Este artefacto no introduce entidades concretas, ramas alternativas ni validaciones que no esten representadas en el analisis del caso.
...
| CoordinadorAsignarTareaAUsuario | Control | Coordina el caso de uso y delega en servicios conceptuales. |
...
1. Actor SdR solicita asignarTareaAUsuario() en la interfaz.
2. Interfaz delega la coordinacion del caso de uso.
3. CoordinadorAsignarTareaAUsuario coordina la responsabilidad de aplicacion.
...
11. CoordinadorAsignarTareaAUsuario devuelve respuesta a la interfaz.
...
| --- | --- | --- | --- |
| [README de analisis](../../../../01-analisis/casos-uso/planificacion-configuracion/asignarTareaAUsuario/README.md) | Mantener el alcance funcional del caso sin anadir detalles no trazados. | Planificacion y configuracion | disenado |
| [Diagrama de colaboracion](../../../../01-analisis/casos-uso/planificacion-configuracion/asignarTareaAUsuario/colaboracion.puml) | Preservar la separacion entre vista, control y dominio. | Interfaz, CoordinadorAsignarTareaAUsuario, ServicioAplicacion, ServicioDominio | disenado |
| [Secuencia de analisis](../../../../01-analisis/casos-uso/planificacion-configuracion/asignarTareaAUsuario/secuencia.puml) | Preservar el orden principal de interaccion. | secuencia.puml, secuencia.svg | disenado |
...
![Secuencia de diseno de asignarTareaAUsuario()](./secuencia.svg)

```plantuml
@startuml asignarTareaAUsuario-diseno-secuencia
title Diseno conceptual: asignarTareaAUsuario()
...
Actor -> Interfaz : 1: solicita asignarTareaAUsuario()
