...
Documentar el diseno conceptual de abrirPlanificacion() manteniendo trazabilidad directa con los diagramas de analisis. Este artefacto no introduce entidades concretas, ramas alternativas ni validaciones que no esten representadas en el analisis del caso.
...
| CoordinadorAbrirPlanificacion | Control | Coordina el caso de uso y delega en servicios conceptuales. |
...
1. Actor SdR solicita abrirPlanificacion() en la interfaz.
2. Interfaz delega la coordinacion del caso de uso.
3. CoordinadorAbrirPlanificacion coordina la responsabilidad de aplicacion.
...
11. CoordinadorAbrirPlanificacion devuelve respuesta a la interfaz.
...
| --- | --- | --- | --- |
| [README de analisis](../../../../01-analisis/casos-uso/planificacion-configuracion/abrirPlanificacion/README.md) | Mantener el alcance funcional del caso sin anadir detalles no trazados. | Planificacion y configuracion | disenado |
| [Diagrama de colaboracion](../../../../01-analisis/casos-uso/planificacion-configuracion/abrirPlanificacion/colaboracion.puml) | Preservar la separacion entre vista, control y dominio. | Interfaz, CoordinadorAbrirPlanificacion, ServicioAplicacion, ServicioDominio | disenado |
| [Secuencia de analisis](../../../../01-analisis/casos-uso/planificacion-configuracion/abrirPlanificacion/secuencia.puml) | Preservar el orden principal de interaccion. | secuencia.puml, secuencia.svg | disenado |
...
![Secuencia de diseno de abrirPlanificacion()](./secuencia.svg)

```plantuml
@startuml abrirPlanificacion-diseno-secuencia
title Diseno conceptual: abrirPlanificacion()
...
Actor -> Interfaz : 1: solicita abrirPlanificacion()
