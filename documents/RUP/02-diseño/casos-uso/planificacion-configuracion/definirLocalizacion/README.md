...
Documentar el diseno conceptual de definirLocalizacion() manteniendo trazabilidad directa con los diagramas de analisis. Este artefacto no introduce entidades concretas, ramas alternativas ni validaciones que no esten representadas en el analisis del caso.
...
| CoordinadorDefinirLocalizacion | Control | Coordina el caso de uso y delega en servicios conceptuales. |
...
1. Actor SdR solicita definirLocalizacion() en la interfaz.
2. Interfaz delega la coordinacion del caso de uso.
3. CoordinadorDefinirLocalizacion coordina la responsabilidad de aplicacion.
...
11. CoordinadorDefinirLocalizacion devuelve respuesta a la interfaz.
...
| --- | --- | --- | --- |
| [README de analisis](../../../../01-analisis/casos-uso/planificacion-configuracion/definirLocalizacion/README.md) | Mantener el alcance funcional del caso sin anadir detalles no trazados. | Planificacion y configuracion | disenado |
| [Diagrama de colaboracion](../../../../01-analisis/casos-uso/planificacion-configuracion/definirLocalizacion/colaboracion.puml) | Preservar la separacion entre vista, control y dominio. | Interfaz, CoordinadorDefinirLocalizacion, ServicioAplicacion, ServicioDominio | disenado |
| [Secuencia de analisis](../../../../01-analisis/casos-uso/planificacion-configuracion/definirLocalizacion/secuencia.puml) | Preservar el orden principal de interaccion. | secuencia.puml, secuencia.svg | disenado |
...
![Secuencia de diseno de definirLocalizacion()](./secuencia.svg)

```plantuml
@startuml definirLocalizacion-diseno-secuencia
title Diseno conceptual: definirLocalizacion()
...
Actor -> Interfaz : 1: solicita definirLocalizacion()
