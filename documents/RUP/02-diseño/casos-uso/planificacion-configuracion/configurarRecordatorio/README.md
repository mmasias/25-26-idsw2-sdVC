...
Documentar el diseno conceptual de configurarRecordatorio() manteniendo trazabilidad directa con los diagramas de analisis. Este artefacto no introduce entidades concretas, ramas alternativas ni validaciones que no esten representadas en el analisis del caso.
...
| CoordinadorConfigurarRecordatorio | Control | Coordina el caso de uso y delega en servicios conceptuales. |
...
1. Actor SdR solicita configurarRecordatorio() en la interfaz.
2. Interfaz delega la coordinacion del caso de uso.
3. CoordinadorConfigurarRecordatorio coordina la responsabilidad de aplicacion.
...
11. CoordinadorConfigurarRecordatorio devuelve respuesta a la interfaz.
...
| --- | --- | --- | --- |
| [README de analisis](../../../../01-analisis/casos-uso/planificacion-configuracion/configurarRecordatorio/README.md) | Mantener el alcance funcional del caso sin anadir detalles no trazados. | Planificacion y configuracion | disenado |
| [Diagrama de colaboracion](../../../../01-analisis/casos-uso/planificacion-configuracion/configurarRecordatorio/colaboracion.puml) | Preservar la separacion entre vista, control y dominio. | Interfaz, CoordinadorConfigurarRecordatorio, ServicioAplicacion, ServicioDominio | disenado |
| [Secuencia de analisis](../../../../01-analisis/casos-uso/planificacion-configuracion/configurarRecordatorio/secuencia.puml) | Preservar el orden principal de interaccion. | secuencia.puml, secuencia.svg | disenado |
...
![Secuencia de diseno de configurarRecordatorio()](./secuencia.svg)

```plantuml
@startuml configurarRecordatorio-diseno-secuencia
title Diseno conceptual: configurarRecordatorio()
...
Actor -> Interfaz : 1: solicita configurarRecordatorio()
