...
Documentar el diseno conceptual de abrirTareas() manteniendo trazabilidad directa con los diagramas de analisis. Este artefacto no introduce entidades concretas, ramas alternativas ni validaciones que no esten representadas en el analisis del caso.
...
| CoordinadorAbrirTareas | Control | Coordina el caso de uso y delega en servicios conceptuales. |
...
1. Actor SdR solicita abrirTareas() en la interfaz.
2. Interfaz delega la coordinacion del caso de uso.
3. CoordinadorAbrirTareas coordina la responsabilidad de aplicacion.
...
11. CoordinadorAbrirTareas devuelve respuesta a la interfaz.
...
| --- | --- | --- | --- |
| [README de analisis](../../../../01-analisis/casos-uso/gestion-tareas/abrirTareas/README.md) | Mantener el alcance funcional del caso sin anadir detalles no trazados. | Gestion de tareas | disenado |
| [Diagrama de colaboracion](../../../../01-analisis/casos-uso/gestion-tareas/abrirTareas/colaboracion.puml) | Preservar la separacion entre vista, control y dominio. | Interfaz, CoordinadorAbrirTareas, ServicioAplicacion, ServicioDominio | disenado |
| [Secuencia de analisis](../../../../01-analisis/casos-uso/gestion-tareas/abrirTareas/secuencia.puml) | Preservar el orden principal de interaccion. | secuencia.puml, secuencia.svg | disenado |
...
![Secuencia de diseno de abrirTareas()](./secuencia.svg)

```plantuml
@startuml abrirTareas-diseno-secuencia
title Diseno conceptual: abrirTareas()
...
Actor -> Interfaz : 1: solicita abrirTareas()
