...
Documentar el diseno conceptual de eliminarTarea() manteniendo trazabilidad directa con los diagramas de analisis. Este artefacto no introduce entidades concretas, ramas alternativas ni validaciones que no esten representadas en el analisis del caso.
...
| CoordinadorEliminarTarea | Control | Coordina el caso de uso y delega en servicios conceptuales. |
...
1. Actor SdR solicita eliminarTarea() en la interfaz.
2. Interfaz delega la coordinacion del caso de uso.
3. CoordinadorEliminarTarea coordina la responsabilidad de aplicacion.
...
11. CoordinadorEliminarTarea devuelve respuesta a la interfaz.
...
| --- | --- | --- | --- |
| [README de analisis](../../../../01-analisis/casos-uso/gestion-tareas/eliminarTarea/README.md) | Mantener el alcance funcional del caso sin anadir detalles no trazados. | Gestion de tareas | disenado |
| [Diagrama de colaboracion](../../../../01-analisis/casos-uso/gestion-tareas/eliminarTarea/colaboracion.puml) | Preservar la separacion entre vista, control y dominio. | Interfaz, CoordinadorEliminarTarea, ServicioAplicacion, ServicioDominio | disenado |
| [Secuencia de analisis](../../../../01-analisis/casos-uso/gestion-tareas/eliminarTarea/secuencia.puml) | Preservar el orden principal de interaccion. | secuencia.puml, secuencia.svg | disenado |
...
![Secuencia de diseno de eliminarTarea()](./secuencia.svg)

```plantuml
@startuml eliminarTarea-diseno-secuencia
title Diseno conceptual: eliminarTarea()
...
Actor -> Interfaz : 1: solicita eliminarTarea()
