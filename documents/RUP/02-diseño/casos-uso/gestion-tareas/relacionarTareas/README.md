...
Documentar el diseno conceptual de relacionarTareas() manteniendo trazabilidad directa con los diagramas de analisis. Este artefacto no introduce entidades concretas, ramas alternativas ni validaciones que no esten representadas en el analisis del caso.
...
| CoordinadorRelacionarTareas | Control | Coordina el caso de uso y delega en servicios conceptuales. |
...
1. Actor SdR solicita relacionarTareas() en la interfaz.
2. Interfaz delega la coordinacion del caso de uso.
3. CoordinadorRelacionarTareas coordina la responsabilidad de aplicacion.
...
11. CoordinadorRelacionarTareas devuelve respuesta a la interfaz.
...
| --- | --- | --- | --- |
| [README de analisis](../../../../01-analisis/casos-uso/gestion-tareas/relacionarTareas/README.md) | Mantener el alcance funcional del caso sin anadir detalles no trazados. | Gestion de tareas | disenado |
| [Diagrama de colaboracion](../../../../01-analisis/casos-uso/gestion-tareas/relacionarTareas/colaboracion.puml) | Preservar la separacion entre vista, control y dominio. | Interfaz, CoordinadorRelacionarTareas, ServicioAplicacion, ServicioDominio | disenado |
| [Secuencia de analisis](../../../../01-analisis/casos-uso/gestion-tareas/relacionarTareas/secuencia.puml) | Preservar el orden principal de interaccion. | secuencia.puml, secuencia.svg | disenado |
...
![Secuencia de diseno de relacionarTareas()](./secuencia.svg)

```plantuml
@startuml relacionarTareas-diseno-secuencia
title Diseno conceptual: relacionarTareas()
...
Actor -> Interfaz : 1: solicita relacionarTareas()
