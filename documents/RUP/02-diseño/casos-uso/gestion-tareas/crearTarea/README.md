...
Documentar el diseno conceptual de crearTarea() manteniendo trazabilidad directa con los diagramas de analisis. Este artefacto no introduce entidades concretas, ramas alternativas ni validaciones que no esten representadas en el analisis del caso.
...
| CoordinadorCrearTarea | Control | Coordina el caso de uso y delega en servicios conceptuales. |
...
1. Actor SdR solicita crearTarea() en la interfaz.
2. Interfaz delega la coordinacion del caso de uso.
3. CoordinadorCrearTarea coordina la responsabilidad de aplicacion.
...
11. CoordinadorCrearTarea devuelve respuesta a la interfaz.
...
| --- | --- | --- | --- |
| [README de analisis](../../../../01-analisis/casos-uso/gestion-tareas/crearTarea/README.md) | Mantener el alcance funcional del caso sin anadir detalles no trazados. | Gestion de tareas | disenado |
| [Diagrama de colaboracion](../../../../01-analisis/casos-uso/gestion-tareas/crearTarea/colaboracion.puml) | Preservar la separacion entre vista, control y dominio. | Interfaz, CoordinadorCrearTarea, ServicioAplicacion, ServicioDominio | disenado |
| [Secuencia de analisis](../../../../01-analisis/casos-uso/gestion-tareas/crearTarea/secuencia.puml) | Preservar el orden principal de interaccion. | secuencia.puml, secuencia.svg | disenado |
...
![Secuencia de diseno de crearTarea()](./secuencia.svg)

```plantuml
@startuml crearTarea-diseno-secuencia
title Diseno conceptual: crearTarea()
...
Actor -> Interfaz : 1: solicita crearTarea()
