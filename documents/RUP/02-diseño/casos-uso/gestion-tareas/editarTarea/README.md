...
Documentar el diseno conceptual de editarTarea() manteniendo trazabilidad directa con los diagramas de analisis. Este artefacto no introduce entidades concretas, ramas alternativas ni validaciones que no esten representadas en el analisis del caso.
...
| CoordinadorEditarTarea | Control | Coordina el caso de uso y delega en servicios conceptuales. |
...
1. Actor SdR solicita editarTarea() en la interfaz.
2. Interfaz delega la coordinacion del caso de uso.
3. CoordinadorEditarTarea coordina la responsabilidad de aplicacion.
...
11. CoordinadorEditarTarea devuelve respuesta a la interfaz.
...
| --- | --- | --- | --- |
| [README de analisis](../../../../01-analisis/casos-uso/gestion-tareas/editarTarea/README.md) | Mantener el alcance funcional del caso sin anadir detalles no trazados. | Gestion de tareas | disenado |
| [Diagrama de colaboracion](../../../../01-analisis/casos-uso/gestion-tareas/editarTarea/colaboracion.puml) | Preservar la separacion entre vista, control y dominio. | Interfaz, CoordinadorEditarTarea, ServicioAplicacion, ServicioDominio | disenado |
| [Secuencia de analisis](../../../../01-analisis/casos-uso/gestion-tareas/editarTarea/secuencia.puml) | Preservar el orden principal de interaccion. | secuencia.puml, secuencia.svg | disenado |
...
![Secuencia de diseno de editarTarea()](./secuencia.svg)

```plantuml
@startuml editarTarea-diseno-secuencia
title Diseno conceptual: editarTarea()
...
Actor -> Interfaz : 1: solicita editarTarea()
