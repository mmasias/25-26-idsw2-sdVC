...
| Modulo funcional | Gestion de sesion |

## Proposito

Documentar el diseno conceptual de completarGestion() manteniendo trazabilidad directa con los diagramas de analisis. Este artefacto no introduce entidades concretas, ramas alternativas ni validaciones que no esten representadas en el analisis del caso.
...
| CoordinadorCompletarGestion | Control | Coordina el caso de uso y delega en servicios conceptuales. |
...
1. Actor SdR solicita completarGestion() en la interfaz.
2. Interfaz delega la coordinacion del caso de uso.
3. CoordinadorCompletarGestion coordina la responsabilidad de aplicacion.
...
11. CoordinadorCompletarGestion devuelve respuesta a la interfaz.
...
| --- | --- | --- | --- |
| [README de analisis](../../../../01-analisis/casos-uso/gestion-sesion/completarGestion/README.md) | Mantener el alcance funcional del caso sin anadir detalles no trazados. | Gestion de sesion | disenado |
| [Diagrama de colaboracion](../../../../01-analisis/casos-uso/gestion-sesion/completarGestion/colaboracion.puml) | Preservar la separacion entre vista, control y dominio. | Interfaz, CoordinadorCompletarGestion, ServicioAplicacion, ServicioDominio | disenado |
| [Secuencia de analisis](../../../../01-analisis/casos-uso/gestion-sesion/completarGestion/secuencia.puml) | Preservar el orden principal de interaccion. | secuencia.puml, secuencia.svg | disenado |
...
![Secuencia de diseno de completarGestion()](./secuencia.svg)

```plantuml
@startuml completarGestion-diseno-secuencia
title Diseno conceptual: completarGestion()
...
Actor -> Interfaz : 1: solicita completarGestion()
