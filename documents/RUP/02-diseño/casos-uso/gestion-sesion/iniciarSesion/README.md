...
Documentar el diseno conceptual de iniciarSesion() manteniendo trazabilidad directa con los diagramas de analisis. Este artefacto no introduce entidades concretas, ramas alternativas ni validaciones que no esten representadas en el analisis del caso.
...
| CoordinadorIniciarSesion | Control | Coordina el caso de uso y delega en servicios conceptuales. |
...
1. Actor SdR solicita iniciarSesion() en la interfaz.
2. Interfaz delega la coordinacion del caso de uso.
3. CoordinadorIniciarSesion coordina la responsabilidad de aplicacion.
...
11. CoordinadorIniciarSesion devuelve respuesta a la interfaz.
...
| --- | --- | --- | --- |
| [README de analisis](../../../../01-analisis/casos-uso/gestion-sesion/iniciarSesion/README.md) | Mantener el alcance funcional del caso sin anadir detalles no trazados. | Gestion de sesion | disenado |
| [Diagrama de colaboracion](../../../../01-analisis/casos-uso/gestion-sesion/iniciarSesion/colaboracion.puml) | Preservar la separacion entre vista, control y dominio. | Interfaz, CoordinadorIniciarSesion, ServicioAplicacion, ServicioDominio | disenado |
| [Secuencia de analisis](../../../../01-analisis/casos-uso/gestion-sesion/iniciarSesion/secuencia.puml) | Preservar el orden principal de interaccion. | secuencia.puml, secuencia.svg | disenado |
...
![Secuencia de diseno de iniciarSesion()](./secuencia.svg)

```plantuml
@startuml iniciarSesion-diseno-secuencia
title Diseno conceptual: iniciarSesion()
...
Actor -> Interfaz : 1: solicita iniciarSesion()
