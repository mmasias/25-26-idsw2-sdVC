...
Documentar el diseno conceptual de editarMiembro() manteniendo trazabilidad directa con los diagramas de analisis. Este artefacto no introduce entidades concretas, ramas alternativas ni validaciones que no esten representadas en el analisis del caso.
...
| CoordinadorEditarMiembro | Control | Coordina el caso de uso y delega en servicios conceptuales. |
...
1. Actor SdR solicita editarMiembro() en la interfaz.
2. Interfaz delega la coordinacion del caso de uso.
3. CoordinadorEditarMiembro coordina la responsabilidad de aplicacion.
...
11. CoordinadorEditarMiembro devuelve respuesta a la interfaz.
...
| --- | --- | --- | --- |
| [README de analisis](../../../../01-analisis/casos-uso/gestion-grupos/editarMiembro/README.md) | Mantener el alcance funcional del caso sin anadir detalles no trazados. | Gestion de grupos y usuarios | disenado |
| [Diagrama de colaboracion](../../../../01-analisis/casos-uso/gestion-grupos/editarMiembro/colaboracion.puml) | Preservar la separacion entre vista, control y dominio. | Interfaz, CoordinadorEditarMiembro, ServicioAplicacion, ServicioDominio | disenado |
| [Secuencia de analisis](../../../../01-analisis/casos-uso/gestion-grupos/editarMiembro/secuencia.puml) | Preservar el orden principal de interaccion. | secuencia.puml, secuencia.svg | disenado |
...
![Secuencia de diseno de editarMiembro()](./secuencia.svg)

```plantuml
@startuml editarMiembro-diseno-secuencia
title Diseno conceptual: editarMiembro()
...
Actor -> Interfaz : 1: solicita editarMiembro()
