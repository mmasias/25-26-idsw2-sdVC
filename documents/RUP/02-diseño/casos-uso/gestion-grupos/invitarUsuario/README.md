...
Documentar el diseno conceptual de invitarUsuario() manteniendo trazabilidad directa con los diagramas de analisis. Este artefacto no introduce entidades concretas, ramas alternativas ni validaciones que no esten representadas en el analisis del caso.
...
| CoordinadorInvitarUsuario | Control | Coordina el caso de uso y delega en servicios conceptuales. |
...
1. Actor SdR solicita invitarUsuario() en la interfaz.
2. Interfaz delega la coordinacion del caso de uso.
3. CoordinadorInvitarUsuario coordina la responsabilidad de aplicacion.
...
11. CoordinadorInvitarUsuario devuelve respuesta a la interfaz.
...
| --- | --- | --- | --- |
| [README de analisis](../../../../01-analisis/casos-uso/gestion-grupos/invitarUsuario/README.md) | Mantener el alcance funcional del caso sin anadir detalles no trazados. | Gestion de grupos y usuarios | disenado |
| [Diagrama de colaboracion](../../../../01-analisis/casos-uso/gestion-grupos/invitarUsuario/colaboracion.puml) | Preservar la separacion entre vista, control y dominio. | Interfaz, CoordinadorInvitarUsuario, ServicioAplicacion, ServicioDominio | disenado |
| [Secuencia de analisis](../../../../01-analisis/casos-uso/gestion-grupos/invitarUsuario/secuencia.puml) | Preservar el orden principal de interaccion. | secuencia.puml, secuencia.svg | disenado |
...
![Secuencia de diseno de invitarUsuario()](./secuencia.svg)

```plantuml
@startuml invitarUsuario-diseno-secuencia
title Diseno conceptual: invitarUsuario()
...
Actor -> Interfaz : 1: solicita invitarUsuario()
