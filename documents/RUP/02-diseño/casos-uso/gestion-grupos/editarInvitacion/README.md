...
Documentar el diseno conceptual de editarInvitacion() manteniendo trazabilidad directa con los diagramas de analisis. Este artefacto no introduce entidades concretas, ramas alternativas ni validaciones que no esten representadas en el analisis del caso.
...
| CoordinadorEditarInvitacion | Control | Coordina el caso de uso y delega en servicios conceptuales. |
...
1. Actor SdR solicita editarInvitacion() en la interfaz.
2. Interfaz delega la coordinacion del caso de uso.
3. CoordinadorEditarInvitacion coordina la responsabilidad de aplicacion.
...
11. CoordinadorEditarInvitacion devuelve respuesta a la interfaz.
...
| --- | --- | --- | --- |
| [README de analisis](../../../../01-analisis/casos-uso/gestion-grupos/editarInvitacion/README.md) | Mantener el alcance funcional del caso sin anadir detalles no trazados. | Gestion de grupos y usuarios | disenado |
| [Diagrama de colaboracion](../../../../01-analisis/casos-uso/gestion-grupos/editarInvitacion/colaboracion.puml) | Preservar la separacion entre vista, control y dominio. | Interfaz, CoordinadorEditarInvitacion, ServicioAplicacion, ServicioDominio | disenado |
| [Secuencia de analisis](../../../../01-analisis/casos-uso/gestion-grupos/editarInvitacion/secuencia.puml) | Preservar el orden principal de interaccion. | secuencia.puml, secuencia.svg | disenado |
...
![Secuencia de diseno de editarInvitacion()](./secuencia.svg)

```plantuml
@startuml editarInvitacion-diseno-secuencia
title Diseno conceptual: editarInvitacion()
...
Actor -> Interfaz : 1: solicita editarInvitacion()
