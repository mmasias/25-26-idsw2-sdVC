...
Documentar el diseno conceptual de eliminarGrupo() manteniendo trazabilidad directa con los diagramas de analisis. Este artefacto no introduce entidades concretas, ramas alternativas ni validaciones que no esten representadas en el analisis del caso.
...
| CoordinadorEliminarGrupo | Control | Coordina el caso de uso y delega en servicios conceptuales. |
...
1. Actor SdR solicita eliminarGrupo() en la interfaz.
2. Interfaz delega la coordinacion del caso de uso.
3. CoordinadorEliminarGrupo coordina la responsabilidad de aplicacion.
...
11. CoordinadorEliminarGrupo devuelve respuesta a la interfaz.
...
| --- | --- | --- | --- |
| [README de analisis](../../../../01-analisis/casos-uso/gestion-grupos/eliminarGrupo/README.md) | Mantener el alcance funcional del caso sin anadir detalles no trazados. | Gestion de grupos y usuarios | disenado |
| [Diagrama de colaboracion](../../../../01-analisis/casos-uso/gestion-grupos/eliminarGrupo/colaboracion.puml) | Preservar la separacion entre vista, control y dominio. | Interfaz, CoordinadorEliminarGrupo, ServicioAplicacion, ServicioDominio | disenado |
| [Secuencia de analisis](../../../../01-analisis/casos-uso/gestion-grupos/eliminarGrupo/secuencia.puml) | Preservar el orden principal de interaccion. | secuencia.puml, secuencia.svg | disenado |
...
![Secuencia de diseno de eliminarGrupo()](./secuencia.svg)

```plantuml
@startuml eliminarGrupo-diseno-secuencia
title Diseno conceptual: eliminarGrupo()
...
Actor -> Interfaz : 1: solicita eliminarGrupo()
