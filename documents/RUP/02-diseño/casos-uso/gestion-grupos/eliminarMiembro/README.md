...
Documentar el diseno conceptual de eliminarMiembro() manteniendo trazabilidad directa con los diagramas de analisis. Este artefacto no introduce entidades concretas, ramas alternativas ni validaciones que no esten representadas en el analisis del caso.
...
| CoordinadorEliminarMiembro | Control | Coordina el caso de uso y delega en servicios conceptuales. |
...
1. Actor SdR solicita eliminarMiembro() en la interfaz.
2. Interfaz delega la coordinacion del caso de uso.
3. CoordinadorEliminarMiembro coordina la responsabilidad de aplicacion.
...
11. CoordinadorEliminarMiembro devuelve respuesta a la interfaz.
...
| --- | --- | --- | --- |
| [README de analisis](../../../../01-analisis/casos-uso/gestion-grupos/eliminarMiembro/README.md) | Mantener el alcance funcional del caso sin anadir detalles no trazados. | Gestion de grupos y usuarios | disenado |
| [Diagrama de colaboracion](../../../../01-analisis/casos-uso/gestion-grupos/eliminarMiembro/colaboracion.puml) | Preservar la separacion entre vista, control y dominio. | Interfaz, CoordinadorEliminarMiembro, ServicioAplicacion, ServicioDominio | disenado |
| [Secuencia de analisis](../../../../01-analisis/casos-uso/gestion-grupos/eliminarMiembro/secuencia.puml) | Preservar el orden principal de interaccion. | secuencia.puml, secuencia.svg | disenado |
...
![Secuencia de diseno de eliminarMiembro()](./secuencia.svg)

```plantuml
@startuml eliminarMiembro-diseno-secuencia
title Diseno conceptual: eliminarMiembro()
...
Actor -> Interfaz : 1: solicita eliminarMiembro()
