...
Documentar el diseno conceptual de editarGrupo() manteniendo trazabilidad directa con los diagramas de analisis. Este artefacto no introduce entidades concretas, ramas alternativas ni validaciones que no esten representadas en el analisis del caso.
...
| CoordinadorEditarGrupo | Control | Coordina el caso de uso y delega en servicios conceptuales. |
...
1. Actor SdR solicita editarGrupo() en la interfaz.
2. Interfaz delega la coordinacion del caso de uso.
3. CoordinadorEditarGrupo coordina la responsabilidad de aplicacion.
...
11. CoordinadorEditarGrupo devuelve respuesta a la interfaz.
...
| --- | --- | --- | --- |
| [README de analisis](../../../../01-analisis/casos-uso/gestion-grupos/editarGrupo/README.md) | Mantener el alcance funcional del caso sin anadir detalles no trazados. | Gestion de grupos y usuarios | disenado |
| [Diagrama de colaboracion](../../../../01-analisis/casos-uso/gestion-grupos/editarGrupo/colaboracion.puml) | Preservar la separacion entre vista, control y dominio. | Interfaz, CoordinadorEditarGrupo, ServicioAplicacion, ServicioDominio | disenado |
| [Secuencia de analisis](../../../../01-analisis/casos-uso/gestion-grupos/editarGrupo/secuencia.puml) | Preservar el orden principal de interaccion. | secuencia.puml, secuencia.svg | disenado |
...
![Secuencia de diseno de editarGrupo()](./secuencia.svg)

```plantuml
@startuml editarGrupo-diseno-secuencia
title Diseno conceptual: editarGrupo()
...
Actor -> Interfaz : 1: solicita editarGrupo()
