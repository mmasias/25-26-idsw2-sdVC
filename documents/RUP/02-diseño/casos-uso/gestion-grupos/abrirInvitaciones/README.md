...
| Modulo funcional | Gestion de grupos y usuarios |

## Proposito

Documentar el diseno conceptual de abrirInvitaciones() manteniendo trazabilidad directa con los diagramas de analisis. Este artefacto no introduce entidades concretas, ramas alternativas ni validaciones que no esten representadas en el analisis del caso.
...
| CoordinadorAbrirInvitaciones | Control | Coordina el caso de uso y delega en servicios conceptuales. |
...
1. Actor SdR solicita abrirInvitaciones() en la interfaz.
2. Interfaz delega la coordinacion del caso de uso.
3. CoordinadorAbrirInvitaciones coordina la responsabilidad de aplicacion.
...
11. CoordinadorAbrirInvitaciones devuelve respuesta a la interfaz.
...
| --- | --- | --- | --- |
| [README de analisis](../../../../01-analisis/casos-uso/gestion-grupos/abrirInvitaciones/README.md) | Mantener el alcance funcional del caso sin anadir detalles no trazados. | Gestion de grupos y usuarios | disenado |
| [Diagrama de colaboracion](../../../../01-analisis/casos-uso/gestion-grupos/abrirInvitaciones/colaboracion.puml) | Preservar la separacion entre vista, control y dominio. | Interfaz, CoordinadorAbrirInvitaciones, ServicioAplicacion, ServicioDominio | disenado |
| [Secuencia de analisis](../../../../01-analisis/casos-uso/gestion-grupos/abrirInvitaciones/secuencia.puml) | Preservar el orden principal de interaccion. | secuencia.puml, secuencia.svg | disenado |
...
![Secuencia de diseno de abrirInvitaciones()](./secuencia.svg)

```plantuml
@startuml abrirInvitaciones-diseno-secuencia
title Diseno conceptual: abrirInvitaciones()
...
Actor -> Interfaz : 1: solicita abrirInvitaciones()
