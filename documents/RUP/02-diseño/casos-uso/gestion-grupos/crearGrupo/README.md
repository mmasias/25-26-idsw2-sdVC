...
Documentar el diseno conceptual de crearGrupo() manteniendo trazabilidad directa con los diagramas de analisis. Este artefacto no introduce entidades concretas, ramas alternativas ni validaciones que no esten representadas en el analisis del caso.
...
| CoordinadorCrearGrupo | Control | Coordina el caso de uso y delega en servicios conceptuales. |
...
1. Actor SdR solicita crearGrupo() en la interfaz.
2. Interfaz delega la coordinacion del caso de uso.
3. CoordinadorCrearGrupo coordina la responsabilidad de aplicacion.
...
11. CoordinadorCrearGrupo devuelve respuesta a la interfaz.
...
| --- | --- | --- | --- |
| [README de analisis](../../../../01-analisis/casos-uso/gestion-grupos/crearGrupo/README.md) | Mantener el alcance funcional del caso sin anadir detalles no trazados. | Gestion de grupos y usuarios | disenado |
| [Diagrama de colaboracion](../../../../01-analisis/casos-uso/gestion-grupos/crearGrupo/colaboracion.puml) | Preservar la separacion entre vista, control y dominio. | Interfaz, CoordinadorCrearGrupo, ServicioAplicacion, ServicioDominio | disenado |
| [Secuencia de analisis](../../../../01-analisis/casos-uso/gestion-grupos/crearGrupo/secuencia.puml) | Preservar el orden principal de interaccion. | secuencia.puml, secuencia.svg | disenado |
...
![Secuencia de diseno de crearGrupo()](./secuencia.svg)

```plantuml
@startuml crearGrupo-diseno-secuencia
title Diseno conceptual: crearGrupo()
...
Actor -> Interfaz : 1: solicita crearGrupo()
