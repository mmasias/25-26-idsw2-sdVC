...
Documentar el diseno conceptual de abrirGrupos() manteniendo trazabilidad directa con los diagramas de analisis. Este artefacto no introduce entidades concretas, ramas alternativas ni validaciones que no esten representadas en el analisis del caso.
...
| CoordinadorAbrirGrupos | Control | Coordina el caso de uso y delega en servicios conceptuales. |
...
1. Actor SdR solicita abrirGrupos() en la interfaz.
2. Interfaz delega la coordinacion del caso de uso.
3. CoordinadorAbrirGrupos coordina la responsabilidad de aplicacion.
...
11. CoordinadorAbrirGrupos devuelve respuesta a la interfaz.
...
| --- | --- | --- | --- |
| [README de analisis](../../../../01-analisis/casos-uso/gestion-grupos/abrirGrupos/README.md) | Mantener el alcance funcional del caso sin anadir detalles no trazados. | Gestion de grupos y usuarios | disenado |
| [Diagrama de colaboracion](../../../../01-analisis/casos-uso/gestion-grupos/abrirGrupos/colaboracion.puml) | Preservar la separacion entre vista, control y dominio. | Interfaz, CoordinadorAbrirGrupos, ServicioAplicacion, ServicioDominio | disenado |
| [Secuencia de analisis](../../../../01-analisis/casos-uso/gestion-grupos/abrirGrupos/secuencia.puml) | Preservar el orden principal de interaccion. | secuencia.puml, secuencia.svg | disenado |
...
![Secuencia de diseno de abrirGrupos()](./secuencia.svg)

```plantuml
@startuml abrirGrupos-diseno-secuencia
title Diseno conceptual: abrirGrupos()
...
Actor -> Interfaz : 1: solicita abrirGrupos()
