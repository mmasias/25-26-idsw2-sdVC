...
Permite al investigador autenticarse en la plataforma introduciendo sus credenciales; Spring Security valida el usuario y redirige al panel principal o muestra un error.

## Diagrama de secuencia

![Diagrama de diseño](../../../images/diseño/investigador/iniciarSesion-diseño.svg)

[Código PlantUML](../../../modelosUML/diseño/investigador/iniciarSesion.puml)
...
- El flujo es idéntico al del coordinador; ambos actores usan el mismo controller y el mismo endpoint de Spring Security.
