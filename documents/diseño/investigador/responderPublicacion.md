...
Registrar una respuesta de texto a una publicación existente. El formulario está embebido en la vista de la publicación. Comportamiento idéntico al del coordinador.

## Diagrama de secuencia

![Diagrama de diseño](../../../images/diseño/investigador/responderPublicacion-investigador-diseño.svg)

[Código PlantUML](../../../modelosUML/diseño/investigador/responderPublicacion.puml)
...
| Repositorio de respuestas | RespuestaRepository JpaRepository | Ejecuta INSERT INTO respuestas vía save(respuesta) |
...
- Tras guardar, redirige al GET de la misma publicación (patrón Post/Redirect/Get).
