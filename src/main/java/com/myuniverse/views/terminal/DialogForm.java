...
public class DialogForm {
    ...
    public void showForm(String title, String[] labels, String[] defaults, String[] comboBoxOptions,
                         int comboBoxFieldIndex) {
        ...
        while (running) {
            ...
            UIUtils.drawBox(g, boxX, boxY, boxW, boxH, title);
            ...
            for (int i = 0; i < labels.length; i++) {
                ...
                if (comboBoxOptions != null && i == comboBoxFieldIndex) {
            ...
            if (field < labels.length) {
                ...
                if (comboBoxOptions == null || field != comboBoxFieldIndex) {
