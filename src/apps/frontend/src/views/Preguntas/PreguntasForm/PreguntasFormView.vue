<template>
  <div class="bg-surface-0 dark:bg-surface-950 p-6">
    ...
    <form @submit.prevent="guardar" class="max-w-2xl space-y-4">
      <div class="field">
      ...
      <div class="space-y-3">
        ...
        <Button
          ...
          icon="pi pi-plus"
          class="p-button-sm"
          @click="form.respuestas.push({ opcion: '', esCorrecta: false })"
...
const asignaturaIdProp = computed(() => props.asignaturaId || preguntasFormStore.getAsignaturaId());
...
async function guardar() {
  try {
    ...
    preguntasFormStore.clearAsignaturaId();
